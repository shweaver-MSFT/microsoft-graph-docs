...
<!-- { "blockType": "ignored" } -->
```http
POST /privilegedAccess/aadRoles/roleAssignmentRequests/{id}/cancel
```
...
```http
POST https://graph.microsoft.com/beta/privilegedAccess/aadRoles/roleAssignmentRequests/7c53453e-d5a4-41e0-8eb1-32d5ec8bfdee/cancel
```
