...
<!-- { "blockType": "ignored" } -->
```http
GET /privilegedAccess/aadRoles/roleSettings/{id}
```
...
```msgraph-interactive
GET https://graph.microsoft.com/beta/privilegedAccess/aadRoles/roleSettings/80dc5d6f-8d89-47b3-953f-01dc909ed3f9
```
